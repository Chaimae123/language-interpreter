...
import com.codechallenge.demo.Service.InterpreterImp;
...
public class InterpreterController {
    ...
    private InterpreterImp pythonParser = new InterpreterImp();
    ...
    public Response<ScatterChart> parseChartsData(@RequestBody String code){
        ...
        return new Response<>(list, inputData.getSeries());
    }
